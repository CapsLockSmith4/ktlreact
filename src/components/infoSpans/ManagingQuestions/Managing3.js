        ...
        (!lang) ? (
            <div className="row">
                <div id="answer3" className="answer answer3">
                    ...
                    <p className="content">There are two types of fines: penalty notices and court fines. Penalty notices are also referred to as "on the spot" fines. Common examples include speeding tickets issued by the Police when driving and parking fines. Court fines are imposed by a court following a finding of guilt. If you have not paid a fine the <a className="ng-scope" href="https://www.revenue.nsw.gov.au/fines">NSW State Debt Recovery Office</a> (SDR) may seek to recover the money you owe. If you are a visiting driver who holds an international licence, your visiting driver privileges (including not having to hold a NSW driver licence) may be cancelled if you fail to pay fines issued for traffic offences. Legal Aid NSW provides information if you are having <a className="ng-scope" href="http://www.legalaid.nsw.gov.au/publications/factsheets-and-resources/are-you-having-problems-with-fines">problems in paying your fines</a> and they have collaborated with the Inner Community Legal Centre and the Redfern Legal Centre on a very <a className="ng-scope" href="http://www.iclc.org.au/finedout/">helpful guide</a> relating to fines.</p>

                    <p className="content">The best option regarding any money that you legally owe is to pay it off in full as quickly as possible. However, if you are unable to do this there are various options available:</p>
                    ...
                    <p className="content">For advice call Aboriginal Department in Financial Rights - Mob Strong Debt Help on 1800 808 488 or the Financial Rights Legal Centre Credit &amp; Debt Hotline on 1800 007 007.</p>
                </div>
            </div>
    ) : (
        <div className="row">
