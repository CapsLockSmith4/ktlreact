...
const Bankruptcy1 = ({lang}) => {
    return (
        ...
        <p class="content">
            破产是一个声明您无法偿还债务的过程。您可以自行宣布破产，或者在某些情况下，您欠钱的对象可以申请让您破产。破产会产生巨大的成本和收益，因此不论做出何种决定都应经过慎重考虑。<a class="ng-scope" href="https://www.moneysmart.gov.au/managing-your-money/managing-debts/trouble-with-debt/bankruptcy">ASIC’s ‘Money Smart’ 网站</a>提供有关破产的简单信息。如果考虑宣布破产，您应该寻求法律咨询。
        </p>
    </div>
